...
| `mode` | `compact` | Return up to five properties; use `SearchResultMode.FULL` for the untouched response |
...
Compact mode returns up to five `properties`. Entries may include property
names, links, GPS coordinates, ratings, amenities, images, extracted prices,
rate-per-night details, and nearby places. Use full mode for brands, filters,
metadata, or pagination.
