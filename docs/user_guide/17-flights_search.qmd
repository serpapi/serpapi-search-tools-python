...
Responses commonly include `best_flights`, `other_flights`, `price_insights`,
`airports`, and search metadata. Itinerary objects can contain one or more
flight legs, layovers, total duration, carbon emissions, price, airline, and
booking tokens.
